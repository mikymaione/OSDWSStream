...
namespace webpp
{
    ...
    public:
        Server(unsigned short port, size_t thread_pool_size, const std::string &cert_file,
    ...
    {
    public:
        explicit https_server(const std::string &cert_file, const std::string &private_key_file,
